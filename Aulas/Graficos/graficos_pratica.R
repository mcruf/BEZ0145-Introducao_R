...
obj <- boxplot(dados$body_mass_g)
names(obj)

tmp <- c(dados$body_mass_g, 100000)

boxplot(tmp)
boxplot(log(tmp))


cbind(mean(tmp), mean(dados$body_mass_g))
